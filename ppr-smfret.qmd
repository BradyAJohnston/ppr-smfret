...
```{r}
#| warning: false
df <- read_spectro("data/20220729_dppr10_dye_pre_desalt.csv")
...
fl <- "data/20220729_dppr10_dye_post_desalt.csv"
df <- read_spectro(fl)
...
fl <- "data/sec/20220801_S200_5150_0.3mlmin_5uLinject_Cy3_1_AF647_2.TXT"
